# Chapter 8. Deep Learning Training Techniques
...
## 8.2 Vanishing/Exploding Gradients as a Formula
...
**2. (Hand derivation, Tier B — hints provided)** Show that the sigmoid
