...
## 10.5 Embeddings: word2vec and Node2Vec
...
`(pred - label)` factor as Chapter 3's logistic regression gradient
...
the 34 nodes — compress those down to 2D with the PCA from section 10.4
