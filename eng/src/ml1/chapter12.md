# Chapter 12. Unsupervised Learning & Representation Learning
...
## 12.1 Learning Without Correct Answers
...
## 12.3 Why We Want to Reduce Dimensionality
...
## 12.4 PCA: Finding the Axes That Preserve the Most Variance
...
## 12.5 Embeddings: word2vec and Node2Vec
...
the actual goal (the same pattern as ML2 Chapter 4's observation that
...
the 34 nodes — compress those down to 2D with the PCA from section 12.4
...
## 12.6 Same Random Walk, Different Question: PageRank
...
**Banach fixed point theorem** that **ML2 Chapter 6.2** will use to show
the Bellman optimality equation has a unique solution — "repeatedly
applying some transformation eventually settles at a fixed point that no
longer moves" is the same mathematics, just applied here to "a probability
