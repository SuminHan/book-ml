# Chapter 12. 비지도학습과 표현학습 (Unsupervised Learning & Representation Learning)
...
34개 노드 각각의 임베딩 벡터가 나온다 — 이 벡터를 12.4의 PCA로 2차원까지
...
이 거듭제곱법이 왜 수렴하는지는, **ML2 Chapter 6.2**에서 벨만 최적방정식의
