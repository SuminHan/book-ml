...
| 2022 | ChatGPT — 사전학습 + RLHF[^rlhf]로 조정된 대규모 언어모델의 대중화 (Chapter 13) |
...
| 13 | LLM: 언어모델링, 프롬프팅, SFT·RLHF·DPO[^dpo] | B |
| 14 | 표현학습: PCA, word2vec, Node2Vec[^node2vec], PageRank | B |
...
| Hugging Face Transformers[^huggingface] | LLM 프롬프팅, 사전학습 모델 활용 | Chapter 13 |
...
[^rlhf]: Ouyang, L. et al. (2022). "Training language models to follow instructions with human feedback." arXiv:2203.02155.
