...
[STUB: cq 확인 필요 — 이 장은 core 16개 챕터 밖의 **부록**으로 재배치됨
(원래 13장). "다음 장(Chapter 14)" 언급을 걷어내고, "12장 이후 core
커리큘럼(13~16장)을 다 마친 뒤 읽는 심화/응용 부록"이라는 위치를
명확히 하는 문단으로 이 도입부의 후반 절반을 다시 쓸 것.]
