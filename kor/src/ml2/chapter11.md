# Chapter 11. 생성형 모델 II: 적대적/스코어 기반 (Generative Models II: Adversarial & Score-Based)
...
## 11.5 또 다른 원리: Diffusion — 노이즈를 점진적으로 되돌리기
